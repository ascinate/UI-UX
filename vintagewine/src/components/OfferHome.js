                ...
                <div className="row">
                    <div className="col-lg-8">
                        <div className="row row-cols-1 row-cols-md-2 gy-4 gy-lg-0 gx-lg-4 justify-content-between align-items-center">
                            <div className="col" data-aos="fade-up">
                                <NavLink to="/shop" className="comon-offer">
                                    ...
                                    <h5 className="col-lg-11 m-auto"> <span className="d-block"> 20% OFF Vintage Prodcuts </span>
                            ...
                            <div className="col" data-aos="fade-down">
                                <NavLink to="/shop" className="comon-offer">
                                    ...
                                    <h5 className="col-lg-11 m-auto"> <span className="d-block"> Free Shpping On Worlwind </span>
                                    on order over 50$ </h5>
                                </NavLink>
                            </div>
                        </div>
                        <div className="big-div-offer mb-4 mb-lg-0 mt-4" data-aos="fade-up">
                            ...
                            <h5 className="col-lg-6 ms-md-auto"> <span className="d-block"> 20% OFF Red wine </span>
                            on all weekend sale </h5>
                            </a>
                        </div>
                    </div>
                    ...
                    <a href="#" className="comon-offer height-offer">
                        ...
                        <h5 className="col-lg-11 text-center m-auto"> <span className="d-block"> 20% OFF Red wine </span>
                        on all weekend sale </h5>
                    </a>
                    </div>
                </div>
