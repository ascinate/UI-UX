...
function Footer(){
    ...
    return (
        ...
        <footer className="pt-5">
                ...
                <div className="row row-cols-1 row-cols-md-4 footer-bottom-div justify-content-lg-between">
                <div className="col">
                        <div className="comon-footer">
                        <img src={footerlogo} alt="logo"/>
                        <p className="text-white col-lg-9 mt-3"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                        </p>
                    ...
                    <div className="col">
                        <div className="comon-footer justify-content-lg-end d-grid">
                        <h5> About </h5>
                        <ul className="list-unstyled">
                            <li> <NavLink to="/"> Help Center </NavLink>  </li>
                            <li> <NavLink to="/"> Privacy policy </NavLink></li>
